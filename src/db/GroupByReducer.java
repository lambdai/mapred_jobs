...
public class GroupByReducer extends Reducer<BytesWritable, BytesWritable, BytesWritable, BytesWritable> {
	...
	public void setup(Context context) {
		...
		String origin_schema_str=conf.get(Constant.INPUT_TABLE_SCHEMA); // get the schema of the input TABLE! 
